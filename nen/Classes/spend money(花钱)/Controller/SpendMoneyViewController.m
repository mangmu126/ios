...
#import "SeekAdviceController.h"
#import "FindTeacherController.h"
#import "LookMasterController.h"
#import "LookHousekeepingController.h"
...
- (void)setupChildViewControllers
{
    ...
    SeekAdviceController *video = [[SeekAdviceController alloc] init];
    [self addChildViewController:video];
    
    FindTeacherController *voice = [[FindTeacherController alloc] init];
    [self addChildViewController:voice];
    
    LookMasterController *picture = [[LookMasterController alloc] init];
    [self addChildViewController:picture];
    
    LookHousekeepingController *word = [[LookHousekeepingController alloc] init];
