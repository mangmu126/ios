...
@implementation ReligiousViewController
...
{
    BuddhismTableViewController *all = [[BuddhismTableViewController alloc] init];
    [self addChildViewController:all];
    
    TaoismTableViewController *video = [[TaoismTableViewController alloc] init];
    [self addChildViewController:video];
    
    CatholicTableViewController *voice = [[CatholicTableViewController alloc] init];
    [self addChildViewController:voice];
    
    ChristianTableViewController *picture = [[ChristianTableViewController alloc] init];
    [self addChildViewController:picture];
    
    IslamTableViewController *word = [[IslamTableViewController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"佛教",@"道教",@"天主教", @"基督教", @"伊斯兰教"];
