...
#import "TeachingManagementViewController.h"

#import "ChristianTableViewController.h"
...
@interface TempleViewController ()<UIScrollViewDelegate>
/** 当前选中的标题按钮 */
...
{
    TempleHomeViewController *all = [[TempleHomeViewController alloc] init];
    [self addChildViewController:all];
    
    BuddhistCultureViewController *video = [[BuddhistCultureViewController alloc] init];
    [self addChildViewController:video];
    
    ManagementViewController *voice = [[ManagementViewController alloc] init];
    [self addChildViewController:voice];
    
    TeachingManagementViewController *picture = [[TeachingManagementViewController alloc] init];
    [self addChildViewController:picture];
    
    ActivityViewController *word = [[ActivityViewController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"接引侍主页",@"佛教文化",@"内务管理", @"教学管理", @"活动"];
