...
#import "SellCentreController.h"
#import "WarehouseController.h"

@interface SyllabusIssueController ()<UIScrollViewDelegate>
/** 当前选中的标题按钮 */
...
@implementation SyllabusIssueController
...
{
    SellCentreController *sellCentre = [[SellCentreController alloc] init];
    [self addChildViewController:sellCentre];
    
    WarehouseController *warehouse = [[WarehouseController alloc] init];
    [self addChildViewController:warehouse];
}
