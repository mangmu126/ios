//
//  AdviserOrderManagementController.m
//  nen
//
...
@interface AdviserOrderManagementController ()<UIScrollViewDelegate>
/** 当前选中的标题按钮 */
...
@implementation AdviserOrderManagementController
...
{
    AdviserAllController *all = [[AdviserAllController alloc] init];
    [self addChildViewController:all];
    
    AdviserContingenController *contingen = [[AdviserContingenController alloc] init];
    [self addChildViewController:contingen];
    
    AdviserStayPayController *stayPay = [[AdviserStayPayController alloc] init];
    [self addChildViewController:stayPay];
    
    AdviserCompleteController *complete = [[AdviserCompleteController alloc] init];
    [self addChildViewController:complete];
    
    AdviserCloseController *close = [[AdviserCloseController alloc] init];
...
- (void)setupTitlesView
{
    ...
    // 添加标题
    NSArray *titles = @[@"全部",@"待确定",@"待付款", @"已完成", @"关闭"];
